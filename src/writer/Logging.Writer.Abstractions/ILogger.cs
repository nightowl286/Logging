...
public interface ILogger : ILoggerContextFactory
{
   ...
   ILogger Log(SeverityAndPurpose severityAndPurpose, string message, out ulong entryId,
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   ILogger Log(SeverityAndPurpose severityAndPurpose, StackFrame stackFrame, out ulong entryId,
      [CallerFilePath] string file = "", [CallerLineNumber] int line = 0);
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   ILogger Log(SeverityAndPurpose severityAndPurpose, StackTrace stackTrace, out ulong entryId,
      [CallerFilePath] string file = "", [CallerLineNumber] int line = 0);
   ...
   /// </remarks>
   ILogger Log(SeverityAndPurpose severityAndPurpose, Exception exception, out ulong entryId,
      [CallerFilePath] string file = "", [CallerLineNumber] int line = 0);
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   ILogger Log(SeverityAndPurpose severityAndPurpose, Thread thread, out ulong entryId,
      [CallerFilePath] string file = "", [CallerLineNumber] int line = 0);
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   ILogger Log(SeverityAndPurpose severityAndPurpose, Assembly assembly, out ulong entryId,
      [CallerFilePath] string file = "", [CallerLineNumber] int line = 0);
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   ILogger LogAdditionalPath(SeverityAndPurpose severityAndPurpose, string filePath, out ulong entryId,
      [CallerFilePath] string file = "", [CallerLineNumber] int line = 0);
   ...
   ILogEntryBuilder StartEntry(SeverityAndPurpose severityAndPurpose, out ulong entryId,
      [CallerFilePath] string file = "", [CallerLineNumber] int line = 0);
   #endregion
}
