...
/// <summary>
/// Contains useful extension methods for <see cref="ILoggerBase"/> implementations.
/// </summary>
public static class LoggerBaseExtensions
{
   ...
   /// <param name="logger">The <see cref="ILoggerBase"/> instance to use.</param>
   ...
   public static ILoggerBase Log(this ILoggerBase logger, Severity severity, string message,
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   public static ILoggerBase Log(this ILoggerBase logger, Severity severity, StackFrame stackFrame,
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   public static ILoggerBase Log(this ILoggerBase logger, Severity severity, StackTrace stackTrace,
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   public static ILoggerBase Log(this ILoggerBase logger, Severity severity, Exception exception,
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   public static ILoggerBase Log(this ILoggerBase logger, Severity severity, Thread thread,
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   public static ILoggerBase Log(this ILoggerBase logger, Severity severity, Assembly assembly,
   ...
   /// <param name="line">The line in the file from which this method was called. This should be provided by the compiler.</param>
   /// <returns>The logger instance.</returns>
   public static ILoggerBase LogAdditionalPath(this ILoggerBase logger, Severity severity, string filePath,
      [CallerFilePath] string file = "", [CallerLineNumber] int line = 0) => logger.LogAdditionalPath(severity, filePath, out _, file, line);
   ...
   public static ILogEntryBuilder StartEntry(this ILoggerBase logger, Severity severity,
