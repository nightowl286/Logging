...
public sealed class ArgumentNullExceptionHandler : IExceptionDataHandler<ArgumentNullException, IArgumentNullExceptionData>
{
   #region Methods
   /// <inheritdoc/>
   ...
   /// <inheritdoc/>
   public int Count(IArgumentNullExceptionData data)
   {
